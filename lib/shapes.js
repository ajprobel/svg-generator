...
class Circle {
    // taking response input from inquirer to be used in the object itself
    ...
    // This class method handles all of the logic of generating the SVG file
    // It first logs to the console, telling users what it will create
    // It then takes the object properties, appends it to the string literal, and then writes a new SVG file
    render() {
...
// Defining the class for a triangle - repeats logic from above, with different object values
class Triangle {
    constructor(color, text, textColor) {
...
// Defining the class for a Square - repeats logic from above, with different object values
class Square {
    constructor(color, text, textColor) {
        this.width = '150';
        this.height = '150';
